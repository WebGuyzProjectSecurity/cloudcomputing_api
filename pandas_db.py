...
'''
os.environ['OPENSHIFT_MONGODB_DB_URL']="mongodb://admin:fcqINUGent3j@127.0.0.1:27017/mtp30apitest1"
...
connection_string = "mongodb://admin:fcqINUGent3j@127.0.0.1:27017"
...
if 'mtp30apitest1' in myMongo_client.database_names():
    myMongo_London_DB_client = myMongo_client.mtp30apitest1.London_Visitors
else:
